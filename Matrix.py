...
## areas = [250, 6250, 2900, 600, 550, 1700, 3825, 200, 1675, 687, 725, 2175, 469, 1925, 825]
## density_levels = [2,1,1,1,2,2,2,2,3,2,2,1,1,1,3]


# def radius(l1: list) -> None:
#     """
#     """
#     l2 = []
#     l3 = []
#     pi2 = 6.283185307
#     for num in l1:
#         l2.append(round(num/pi2, 1))
#     for num in l2:
#         l3.append(round(2*num, 1))
#     print("Radius: ", l2, '\nDiameter: ', l3)
#
#
# def volume(l1: list, l2: list) -> list:
#     """
#     """
#     l3 = []
#     pi = 3.141592654
...
#         r = l1[i]
#         h = l2[i]
#         l3.append(round(((r**2)*pi*h), 1))
#     return l3

m1 = [[3, 1, -4, -1], [1, 0, 10, 5], [4, 1, 6, 1]]  #Does not work
m1r = [ [1, 0, 10, 5], [0, 1, -34, -16], [0,0,0,-3] ]

# For lab 1 for CSC207:

# inpu is a variable which is assigned to a number greater than or equal to 0
# inpu = 55 + 33
# if inpu == 0:
#     return []
# elif inp
